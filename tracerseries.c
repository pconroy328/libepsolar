...
char *getBatteryStatusVoltage(const uint16_t statusBits)
{
    ...
    switch (statusBits & 0b0000000000001111) {
        ...
        case 0x02: return "Under Voltage";
            break;
        case 0x03: return "Over Discharge";
            break;
        case 0x04: return "Fault";
            break;
    }
    return "???";
}
...
char *getBatteryStatusTemperature(const uint16_t statusBits)
{
    ...
    switch ((statusBits & 0b0000000011110000) >> 4) {
        case 0x00: return "Normal";
            break;
        case 0x01: return "High";       // Higher than High Warning Temp 0x9017
            break;
        case 0x02: return "Low";        // Lower than Low Warning Temp  0x9018
            break;
    }
    return "???";
}
...
char *getChargingEquipmentStatusInputVoltageStatus(const uint16_t statusBits)
{
    ...
    switch ((statusBits & 0b1100000000000000) >> 14) {
        case 0x00: return "Normal";
            break;
        case 0x01: return "No Input Power Connected";
            break;
        case 0x02: return "Higher Input Voltage";
            break;
        case 0x03: return "Input Volt Error";
            break;
    }
...
{ // Bits 2,3              fedcba9876543210
    switch ((statusBits & 0b0000000000001100) >> 2) {
        case 0x00: return "Not Charging";
            break;
        case 0x01: return "Floating";
            break;
        case 0x02: return "Boosting";
            break;
        case 0x03: return "Equalizing";
            break;
    }
...
char *getDischargingStatusInputVoltageStatus(const uint16_t statusBits)
{
    ...
    switch ((statusBits & 0b1100000000000000) >> 14) {
        ...
        case 0x02: return "High";
            break;
        case 0x03: return "No Access - Input Volt Error";
            break;
    }
...
char *getDischargingStatusOutputPower(const uint16_t statusBits)
{
    ...
    switch ((statusBits & 0b0011000000000000) >> 12) {
        case 0x00: return "Light";
            break;
        case 0x01: return "Moderate";
            break;
        case 0x02: return "Rated";
            break;
        case 0x03: return "Overload";
            break;
    }
...
{
    switch (mode) {
        case 0x00: return "Connect/Disconnect";
            break;
        case 0x01: return "PWM";
            break;
        case 0x02: return "MPPT";
            break;
